    ...
    return (
        <section className="flex flex-col items-center px-4 pt-20 pb-24 text-center">
            ...
            >
                ...
                >
                    Unlock the wisdom in{" "}
                    <span className="text-muted-foreground">your digital archive.</span>
                </motion.h1>
                ...
                >
                    SentientArchive turns your scattered documents into a conversational
                    knowledge base. Stop searching, start asking.
                </motion.p>
